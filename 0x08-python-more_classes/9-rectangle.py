...
class Rectangle:
    ...
    def __str__(self):
        ...
        return "\n".join(symb * self.__width for _ in range(self.__height))
    ...
    def square(cls, size=0):
        """
        Returns a rectangle instance with the same dimensions, i.e. square

        Returns:
            Rectangle: rectangle instance with the same h and w
        """
